// config.bin - 19:51:21 11/17/12, generated in 0.12 seconds
...
class cfgWeapons {
	...
	//TODO: ROTATE NEW MAP MODEL TO BE LAYING FLAT
	class ItemMap;	//Ext Ref
	class DZP_Map : ItemMap {
...
class CfgMagazines {
	...
	class Skin_Santa1_DZ : SkinBase {
		scope = public;
		displayName = "Santa Clothing";
		descriptionShort = "Merry Christmas DayZ+ Players... Ho! Ho! Ho!";
	};
	...
	class Skin_Net_DZ : SkinBase {
		...
		class ItemActions {
			class ReloadMag {
				text = "Camo Net";
				script = "spawn player_construct;";
				use[] = {"Skin_Net_DZ","Skin_Net_DZ","Skin_Net_DZ","PartWoodPile"};
				output[] = {"ItemCamoNet"};
			};
			
			class ReloadMag1 {
				text = "Watch Tower";
				script = "spawn player_construct1;";
				use[] = {"Skin_Net_DZ","Skin_Net_DZ","Skin_Net_DZ","Skin_Net_DZ","ItemHBarrier","ItemHBarrier"};
				output[] = {"ItemWatchTower"};
			};
		};
	};
	...
	class PartGeneric : CA_Magazine {
		...
		class ItemActions {
			class ReloadMag {
				text = "Sandbag Nest";
				script = "spawn player_construct;";
				use[] = {"ItemSandbag","ItemSandbag","PartWoodPile","PartWoodPile","PartGeneric"};
				output[] = {"ItemSandBagNest"};
			};
			
			class ReloadMag1 {
				text = "HBarrier";
				script = "spawn player_construct1;";
				use[] = {"ItemWire","ItemWire","PartGeneric","PartGeneric"};
				output[] = {"ItemHBarrier"};
			};
			
			class ReloadMag2 {
				text = "Gate";
				script = "spawn player_construct2;";
				use[] = {"ItemWire","PartGeneric","PartGeneric"};
				output[] = {"ItemGate"};
			};
			
			class ReloadMag3 {
				text = "Scaffolding";
				script = "spawn player_construct3;";
				use[] = {"PartWoodPile","PartWoodPile","PartWoodPile","PartGeneric","PartGeneric","PartGeneric"};
				output[] = {"ItemScaffolding"};
			};
			
			class ReloadMag4 {
				text = "Small Ladder";
				script = "spawn player_construct4;";
				use[] = {"PartGeneric","PartGeneric"};
				output[] = {"ItemLadderSmall"};
			};
			
			class ReloadMag5 {
				text = "Large Ladder";
				script = "spawn player_construct5;";
				use[] = {"PartGeneric","PartGeneric","PartGeneric","PartGeneric"};
				output[] = {"ItemLadderLarge"};
			};
			
			class ReloadMag6 {
				text = "Deer Stand";
				script = "spawn player_construct6;";
				use[] = {"PartWoodPile","PartWoodPile","PartWoodPile","PartWoodPile","PartWoodPile","PartGeneric"};
				output[] = {"ItemDeerStand"};
			};
		};
	};
	...
	class PartWoodPile : CA_Magazine {
		...
		class ItemActions {
			...
			class ReloadMag2 {
				...
				script = "spawn player_construct2;";
				use[] = {"ItemSandbagRound","ItemSandbagRound","PartWoodPile"};
				output[] = {"ItemFortSandbagRound"};
			};
	...
	class ItemSandbag : CA_Magazine {
		...
		class ItemActions {
			...
			class ReloadMag1 {
				...
				script = "spawn player_construct1;";
				use[] = {"ItemSandbag","ItemSandbag"};
				output[] = {"ItemSandbagRound"};
			};
		};
	};
	...
	class ItemSandbagRound : CA_Magazine {
		...
		class ItemActions {
			...
			class ReloadMag {
				...
				use[] = {"ItemSandbagRound"};
				output[] = {"ItemSandbag","ItemSandbag"};
			};
	...
	class ItemFortSandbagRound : CA_Magazine {
		...
		class ItemActions {
			...
			class ReloadMag {
				text = "Deconstruct";
				script = "spawn player_deconstruct;";
				use[] = {"ItemFortSandbagRound"};
				output[] = {"ItemSandbagRound","ItemSandbagRound","PartWoodPile"};
			};
		};
	};
	...
	class ItemWire : CA_Magazine {
		...
		class ItemActions {
			...
			class ReloadMag1 {
				text = "Wire (CAT2)";
				script = "spawn player_construct1;";
				use[] = {"ItemWire","ItemWire","ItemWire"};
				output[] = {"ItemWire2"};
			};
	...
	class ItemWire2 : CA_Magazine {
		...
		class ItemActions {
			...
			class ReloadMag {
				...
				script = "spawn player_deconstruct;";
				use[] = {"ItemWire2"};
				output[] = {"ItemWire","ItemWire","ItemWire"};
			};
		};
	};
	...
	class ItemCamoNet : CA_Magazine {
		...
		class ItemActions {
			...
			class ReloadMag {
				...
				script = "spawn player_deconstruct;";
				use[] = {"ItemCamoNet"};
				output[] = {"Skin_Net_DZ","Skin_Net_DZ","Skin_Net_DZ","PartWoodPile"};
			};
		};
	};
	...
	class ItemSandBagNest : CA_Magazine {
		...
		class ItemActions {
			...
			class ReloadMag {
				...
				script = "spawn player_deconstruct;";
				use[] = {"ItemSandBagNest"};
				output[] = {"ItemSandbag","ItemSandbag","PartWoodPile","PartWoodPile","PartGeneric"};
			};
		};
	};
	...
	class ItemWatchTower : CA_Magazine {
		...
		class ItemActions {
			...
			class ReloadMag {
				...
				script = "spawn player_deconstruct;";
				use[] = {"ItemWatchTower"};
				output[] = {"Skin_Net_DZ","Skin_Net_DZ","Skin_Net_DZ","Skin_Net_DZ","ItemHBarrier","ItemHBarrier"};
			};
		};
	};
	...
	class ItemDeerStand : CA_Magazine {
		...
		class ItemActions {
			...
			class ReloadMag {
				...
				script = "spawn player_deconstruct;";
				use[] = {"ItemDeerStand"};
				output[] = {"PartWoodPile","PartWoodPile","PartWoodPile","PartWoodPile","PartWoodPile","PartGeneric"};
			};
		};
	};
	...
	class ItemHBarrier : CA_Magazine {
		...
		class ItemActions {
			...
			class ReloadMag {
				...
				script = "spawn player_deconstruct;";
				use[] = {"ItemHBarrier"};
				output[] = {"ItemWire","ItemWire","PartGeneric","PartGeneric"};
			};
		};
	};
	class ItemGate : CA_Magazine {
		...
		class ItemActions {
			...
			class ReloadMag {
				...
				script = "spawn player_deconstruct;";
				use[] = {"ItemGate"};
				output[] = {"ItemWire","PartGeneric","PartGeneric"};
			};
		};
	};
	...
	class ItemScaffolding : CA_Magazine {
		...
		class ItemActions {
			...
			class ReloadMag {
				...
				script = "spawn player_deconstruct;";
				use[] = {"ItemScaffolding"};
				output[] = {"PartWoodPile","PartWoodPile","PartWoodPile","PartGeneric","PartGeneric","PartGeneric"};
			};
		};
	};
	...
	class ItemLadderSmall : CA_Magazine {
		...
		class ItemActions {
			...
			class ReloadMag {
				...
				script = "spawn player_deconstruct;";
				use[] = {"ItemLadderSmall"};
				output[] = {"PartGeneric","PartGeneric"};
			};
		};
	};
	...
	class ItemLadderLarge : CA_Magazine {
		...
		class ItemActions {
			...
			class ReloadMag {
				...
				script = "spawn player_deconstruct;";
				use[] = {"ItemLadderLarge"};
				output[] = {"PartGeneric","PartGeneric","PartGeneric","PartGeneric"};
			};
		};
	};
	...
	//TODO: KEY FOR LOCKING GATES
	class ItemKey : CA_Magazine {
		scope = public;
		count = 100000000;
		type = 256;
		displayName = "Key";
		//model = "\dayz_equip\models\generator_gear.p3d"; //GENERATOR MODEL XD
		picture = "\dayz_equip\textures\equip_generator_ca.paa"; //GENERATOR INV PICTURE XD
		descriptionShort = "A key, maybe it unlocks something.";
	};
};
...
class CfgVehicles {
	...
	class DZP_Map : WeaponHolderBase {
		scope = public;
		displayName = "Map";
		model = "\ca\misc\SmallObj_file_map.p3d";
		
		class eventHandlers {
			init = "[(_this select 0),'cfgWeapons','ItemMap'] execVM '\z\addons\dayz_code\init\object_pickupAction.sqf';";
		};
	};
	...
	//TODO: Finish Making Generic Supply Box
/*
	class DZP_Foodbox : CardboardBox {
		scope = public;
...
*/	
	...
	class DZP_Medicalbox : CardboardBox {
		scope = public;
	...
	class Land_Fire;	// External class reference
		//TODO: Remove The Ability To Store Things In Fires
	...
	class AmmoBoxBig : ReammoBox {
		...
		// TODO: Add Random Magzine Amounts For Ammoboxes
		// TODO: Finish Czech Ammoboxes
/*
	class DZP_AmmoBox_US : AmmoBoxSmall {
		displayName = "US Ammobox";
	...
	class DZP_AmmoBox_RU : AmmoBoxSmall {
		displayName = "Russian Ammobox";
	...
	class DZP_AmmoBox_CZ : AmmoBoxSmall {
		displayName = "Russian Ammobox";
