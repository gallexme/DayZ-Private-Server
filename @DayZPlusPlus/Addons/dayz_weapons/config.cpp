// config.bin - 17:28:39 11/19/12, generated in 0.12 seconds
...
class cfgWeapons {
	...
	class Flare : GrenadeLauncher {
		...
		class MolotovCocktailMuzzle : ThrowMuzzle {
			displayName = "Throw";
			magazines[] = {"TrashJackDaniels", "ItemSodaEmpty", "TrashTinCan", "Baseball_DZ"};
			cursor = "Vehicle_Grenade_W";
			cursorAim = "\ca\Weapons\Data\clear_empty";
		};
	};
...
class cfgMagazines {
	...
	class BaseBall_DZ : TrashTinCan {
		displayName = "Baseball";
		model = "\ca\misc2\Baseball\Baseball.p3d";
		picture = "\dayz_equip\textures\equip_baseball_CA.paa";
		descriptionShort = "A Baseball";
		ammo = "Baseball_ammo";
	};
