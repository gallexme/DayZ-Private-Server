...
class CfgBuildingLoot {
	...
	class Residential: Default {
		...
		itemType[] =	{
			...
			{"Skin_Camo5_DZ","magazine"}
		};
		itemChance[] =	{
			0.03,	//Military Loot Pile
			0.48,	//Trash Loot Pile
			1.92,	//Generic Loot Pile					
			0.12,	//Watch
			0.06,	//Compass
			0.03,	//Map
			0.06,	//Flashlight
			...
			0.03,	//ALICE Pack			
			0.01,	//Lee Enfield
			0.03,	//Winchester 1866
			0.03,	//Double Barreled Shotgun
			0.01,	//MP5A5			
			0.01,	//Mtn. Dew
			0.03,	//Camping Tent
			0.01	//Urban Bandit Clothing
		};		
	};	
	...
	class Industrial: Default {
		...
		itemChance[] =	{
			0.24,	//Generic Loot Pile
			0.12,	//Trash Loot Pile
			0.06,	//Military Loot Pile	
			0.12,	//Hatchet
			0.06,	//Hunting Knife
			0.06,	//Toolbox	
			0.03,	//Scrap Metal
			...
			0.03,	//Fueltank Parts
			0.03,	//Engine Parts
			0.03,	//Windscreen Glass
			0.03,	//Main Rotor Assembly
			0.06,	//Jerry Can		
			0.03,	//Wire Fence Kit
			0.03,	//Tank Trap Kit			
	...
	class Farm: Default {
		...
		itemChance[] =	{
			...
			0.01,	//CZ550
			0.03,	//Lee Enfield
			0.06,	//Winchester 1866
			0.06,	//Double Barreled Shotgun		
			0.01,	//Woodland Bandit Clothing
			0.01	//Woodland Ranger Clothing
		};
	};	
	class Supermarket: Default {
		...
		itemChance[] =	{
			...
			0.03,	//ALICE Pack
			0.01,	//Lee Enfield
			0.01,	//Winchester 1866
			0.01,	//Double Barreled Shotgun
			0.01	//Camping Tent
		};
	};
	class UH1YCrash: Default {
		zombieChance = 0;
		maxRoaming = 2;
		...
		itemChance[] =	{
			...
			0.03,	//M24 Desert
			0.03,	//M24
			0.96,	//Military Loot Pile
			0.48,	//Medical Loot Pile		
			0.12,	//Medical Box
			0.12,	//Soldier Clothing
			0.06	//Camo Clothing
		};
	};
	class UH60Crash: Default {
		zombieChance = 0;
		maxRoaming = 2;
		zombieClass[] = {"z_soldier_pilot"};
		lootChance = 0.5;
	...
	class Hospital: Default {
		...
		itemChance[] =	{
			0.12,	//Trash Loot Pile
			0.48,	//Hospital Loot Pile
			0.24	//Medical Supply Box
		};
	};	
	class Military: Default {
		...
		itemChance[] =	{
			0.96,	//Generic Loot Pile
			1.92,	//Military Loot Pile	
			0.48,	//Trash Loot Pile
			0.12,	//Binoculars
			0.12,	//Military Flashlight
			0.12,	//Hunting Knife
			0.01,	//GPS		
			0.12,	//Entrechmant Tool			
			0.24,	//M9
			0.24,	//Scorpian
			0.24,	//PDW			
			0.24,	//G17			
			...
			0.06,	//AK-74 GP25
			0.06,	//AKS
			0.12,	//Remington 870 (Flashlight)
			0.12,	//MP5SD6
			0.01,	//SVD Draganov
			0.06,	//Assualt Pack (ACU)
			0.03,	//Camo Clothing
			0.03,	//Terrorist Clothing
			0.24	//Sandbags
		};
	};
	...
	class MilitarySpecial: Default {
		...
		itemType[] = {
		  ...
		  itemChance[] = {
		   0.24, //Medical Loot Pile
		   0.96, //Generic Loot Pile  
		   1.92, //Military Loot Pile
		   0.12, //Binoculars
		   0.12, //Military Flaslight
		   0.12, //Hunting Knife
		   0.01, //GPS 
		   0.48, //Scorpian
		   0.48, //M9 SD   
		   ...
		   0.03, //PKM
		   0.12, //AK-107 PSO   
		   0.12, //Assualt Pack (ACU)
		   0.12, //Patrol Pack (coyote)
		   0.03, //Backpack (coyote)
		   0.06, //Soldier Clothing
		   0.01, //Ghillie Suit
		   0.03, //Ragged Ghillie Suit
		   0.01 //Satchel Charge
		  };
	};	
