...
if (!isDedicated) then {
	...
	player_construct =			compile preprocessFileLineNumbers "\z\addons\dayz_code\actions\player_constructs.sqf";
	player_deconstruct =		compile preprocessFileLineNumbers "\z\addons\dayz_code\actions\player_deconstructs.sqf";
	player_construct1 =			compile preprocessFileLineNumbers "\z\addons\dayz_code\actions\player_constructs1.sqf";
	player_construct2 =			compile preprocessFileLineNumbers "\z\addons\dayz_code\actions\player_constructs2.sqf";
	player_construct3 =			compile preprocessFileLineNumbers "\z\addons\dayz_code\actions\player_constructs3.sqf";
	player_construct4 =			compile preprocessFileLineNumbers "\z\addons\dayz_code\actions\player_constructs4.sqf";
	player_construct5 =			compile preprocessFileLineNumbers "\z\addons\dayz_code\actions\player_constructs5.sqf";
	player_construct6 =			compile preprocessFileLineNumbers "\z\addons\dayz_code\actions\player_constructs6.sqf";
	...
	//Construction
	construction_key_override = compile preprocessFileLineNumbers "\z\addons\dayz_code\compile\construction_key_override.sqf";
	player_getSlots = compile preprocessFileLineNumbers "\z\addons\dayz_code\compile\player_getSlots.sqf";
	player_freeSlots = compile preprocessFileLineNumbers "\z\addons\dayz_code\compile\player_freeSlots.sqf";
