class CfgVehicles {
	...
	class Soldier1_DZ: US_Soldier_EP1 {
		displayName = "Soldier";
		side = 1;
		weapons[] = {"Throw","Put"};
		backpack = "";
	...
	class Sniper1_DZ: USMC_SoldierS_Sniper {
		displayName = "Sniper";
		side = 1;
		weapons[] = {"Throw","Put"};
		canCarryBackPack = 1;
	...
	class UH60Wreck_DZ: House
	{
		model = "\ca\misc_e\Wreck_UH60_ep1.p3d";
		icon = "\ca\air_e\data\UI\picture_uh60m_ca.paa";
		mapSize = 15;
